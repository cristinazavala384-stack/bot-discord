...
@bot.event
async def on_ready():
    panel = Panel()            # crear el Panel
    panel.is_persistent = True # marcar persistente (SIN paréntesis)
...
# ---------------- INICIAR BOT ----------------
bot.run(os.getenv("TOKEN"))  # ✅ TOKEN desde variable de entorno en Railway
